...
import { VanTextarea, showToast, closeDialog } from "vant";
import { timeAgo } from "../tools";
import  ShoppingCars from '../components/ShoppingCars.vue'; // 确保路径正确
...
export default {
  ...
  methods: {
    ...
    //无用代码
    //  getHeartIconName(index) {

    //   return  this.activeCommentColor = this.activeLike==index ? "red" : "#a1a1a1";
    // },
    dislickEmote() {
      showToast("不喜欢该表情");
    },
